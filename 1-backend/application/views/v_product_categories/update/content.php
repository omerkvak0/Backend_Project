                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card card-info">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form class="form-horizontal" method="POST" action="<?php echo base_url("Product_Categories/update/$item->id") ?>">
                                <div class="card-body">
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="<?php echo base_url("Product_Categories") ?>" class="btn btn-default float-right">Vazgeç</a>
                                </div>
                                <!-- /.card-footer -->
                            </form>
                        </div>
